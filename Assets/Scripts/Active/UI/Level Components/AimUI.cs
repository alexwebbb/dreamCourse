...
public class AimUI : MonoBehaviour {
    ...
    void Update() {
        ...
        if (rotateHorizontalEvent != null) {
            ...
            if (((Input.GetAxisRaw("Horizontal") < -0.5f || leftButton.Pressed) && heldTime > heldButtonInterval) || Input.GetKeyDown(KeyCode.LeftArrow) || Input.GetKeyDown(KeyCode.A)) {
                // rotate left
                rotateHorizontalEvent(left);
                heldTime = 0.0f;
            } else if (((Input.GetAxisRaw("Horizontal") > 0.5f || rightButton.Pressed) && heldTime > heldButtonInterval) || Input.GetKeyDown(KeyCode.RightArrow) || Input.GetKeyDown(KeyCode.D)) {
                // rotate right
        ...
        if (rotateVerticalEvent != null) {
            ...
            if (((Input.GetAxisRaw("Vertical") < -0.5f || downButton.Pressed) && heldTime > heldButtonInterval) || Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.S)) {
                // rotate down
                rotateVerticalEvent(down, false);
                heldTime = 0.0f;
            } else if (((Input.GetAxisRaw("Vertical") > 0.5f || upButton.Pressed) && heldTime > heldButtonInterval) || Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.W)) {
                // rotate up
